...
import { AlertTriangle, Baby, Crown, Download, Globe, LogOut, Palette, Settings, Shield, Trash2, Type, UserCheck } from 'lucide-react';
          ...
          <div className="mt-4 flex items-center justify-between gap-3 rounded-xl bg-lavender-50 px-4 py-3">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Switches to Atkinson Hyperlegible</p>
              </div>
            </div>
            <button
              role="switch"
...
// ── Module accent colours (same as SettingsPage) ─────────────────────
