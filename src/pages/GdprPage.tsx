    ...
    <div className="pb-20">
      <div className="px-4 pt-4 pb-3">
        <div className="mb-4 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-[var(--foreground)]">GDPR &amp; Data Protection</h1>
            <p className="text-sm text-[var(--muted-foreground)]">How we collect, store, and protect your data</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4 px-4">
        {/* Data collected */}
        <section className="rounded-2xl bg-[var(--card)] p-5 shadow-sm ring-1 ring-[var(--border)]">
          <h2 className="mb-3 flex items-center gap-2 text-sm font-bold text-[var(--foreground)]">
            <Database size={16} className="text-violet-500" /> Data We Collect
          </h2>
          <div className="space-y-3 text-sm text-[var(--muted-foreground)]">
            <div>
              <h3 className="font-semibold text-[var(--foreground)]">User account information</h3>
            ...
            <div>
              <h3 className="font-semibold text-[var(--foreground)]">Child profiles</h3>
              <ul className="mt-1 list-disc pl-5 space-y-1">
            ...
            <div>
              <h3 className="font-semibold text-[var(--foreground)]">Tracker &amp; diary data</h3>
              <ul className="mt-1 list-disc pl-5 space-y-1">
            ...
            <div>
              <h3 className="font-semibold text-[var(--foreground)]">Audit trail</h3>
              <ul className="mt-1 list-disc pl-5 space-y-1">
        ...
        <section className="rounded-2xl bg-[var(--card)] p-5 shadow-sm ring-1 ring-[var(--border)]">
          <h2 className="mb-3 flex items-center gap-2 text-sm font-bold text-[var(--foreground)]">
            <Shield size={16} className="text-violet-500" /> How Data Is Stored
          </h2>
          <div className="space-y-3 text-sm text-[var(--muted-foreground)]">
            <div>
              <h3 className="font-semibold text-[var(--foreground)]">Local-first storage</h3>
              <p className="mt-1">
            ...
            <div>
              <h3 className="font-semibold text-[var(--foreground)]">Cloud storage (optional)</h3>
              <p className="mt-1">
            ...
            <div>
              <h3 className="font-semibold text-[var(--foreground)]">Security measures</h3>
              <ul className="mt-1 list-disc pl-5 space-y-1">
        ...
        <section className="rounded-2xl bg-[var(--card)] p-5 shadow-sm ring-1 ring-[var(--border)]">
          <h2 className="mb-3 flex items-center gap-2 text-sm font-bold text-[var(--foreground)]">
            <Eye size={16} className="text-violet-500" /> Your Rights
          </h2>
          <div className="space-y-3 text-sm text-[var(--muted-foreground)]">
            <p>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="rounded-xl bg-[var(--background)] p-3">
                <p className="font-semibold text-[var(--foreground)]">📥 Right to access</p>
                <p className="mt-1 text-xs">You can export all your data at any time from Settings.</p>
              </div>
              <div className="rounded-xl bg-[var(--background)] p-3">
                <p className="font-semibold text-[var(--foreground)]">✏️ Right to rectification</p>
                <p className="mt-1 text-xs">You can edit any entry or profile in the app.</p>
              </div>
              <div className="rounded-xl bg-[var(--background)] p-3">
                <p className="font-semibold text-[var(--foreground)]">🗑️ Right to erasure</p>
                <p className="mt-1 text-xs">You can delete all data or your account from Settings.</p>
              </div>
              <div className="rounded-xl bg-[var(--background)] p-3">
                <p className="font-semibold text-[var(--foreground)]">📦 Right to portability</p>
        ...
        <section className="rounded-2xl bg-[var(--card)] p-5 shadow-sm ring-1 ring-[var(--border)]">
          <h2 className="mb-3 flex items-center gap-2 text-sm font-bold text-[var(--foreground)]">
            <Trash2 size={16} className="text-violet-500" /> Data Deletion
          </h2>
          <div className="space-y-2 text-sm text-[var(--muted-foreground)]">
            <p>
              You can permanently delete all your data at any time from the
              <Link to="/settings" className="mx-1 text-violet-600 underline underline-offset-2">Settings</Link>
        ...
        <section className="rounded-2xl bg-[var(--card)] p-5 shadow-sm ring-1 ring-[var(--border)]">
          <h2 className="mb-3 flex items-center gap-2 text-sm font-bold text-[var(--foreground)]">
            <Clock size={16} className="text-violet-500" /> Data Retention
          </h2>
          <div className="space-y-2 text-sm text-[var(--muted-foreground)]">
            <p>
        ...
        <section className="rounded-2xl bg-[var(--card)] p-5 shadow-sm ring-1 ring-[var(--border)]">
          <h2 className="mb-3 flex items-center gap-2 text-sm font-bold text-[var(--foreground)]">
            <Mail size={16} className="text-violet-500" /> Contact &amp; Support
          </h2>
          <div className="space-y-2 text-sm text-[var(--muted-foreground)]">
            <p>If you have questions about data protection or wish to exercise your rights:</p>
            <p>
              <strong>Email:</strong>{' '}
              <a href="mailto:privacy@childdevelopmenttracker.co.uk" className="text-violet-600 underline underline-offset-2">
