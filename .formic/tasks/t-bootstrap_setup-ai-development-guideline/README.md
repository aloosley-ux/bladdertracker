...
You MUST ONLY examine files within this workspace directory: C:\GIT\bladdertracker
...
The workspace root is: C:\GIT\bladdertracker
...
1. First, explore the repository structure WITHIN THE WORKSPACE ONLY:
   - List the contents of C:\GIT\bladdertracker (the workspace root)
...
Create a file named `kanban-development-guideline.md` in the workspace root (C:\GIT\bladdertracker) with:
...
IMPORTANT: Only document what actually exists in C:\GIT\bladdertracker. Do not describe files or structures from outside this directory.
